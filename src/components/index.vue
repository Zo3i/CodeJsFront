<template>
    <div>
            ...
            <div>
              <button @click="pay">嘻嘻嘻</button>
              <div >
                <form id="pay" :action="submitPay" style="display:none"  method="get" target="_blank">
    ...
    pay() {
      var newWindow = window.open('', '_blank')
       this.$ajax({
          ...
          console.oldLog(res.data.data[0])
          this.submitPay = res.data.data[0]
          newWindow.location.href = res.data.data[0];
